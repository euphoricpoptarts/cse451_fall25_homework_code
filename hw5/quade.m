function [Q,mesh,fevals] = quade(func, a, b, tol, fa, fab2, fb, sab, ...
                                 level, fevals, mesh)
%
...
%   first check if max recursion levels reached
    ...
    if level == 0
      ...
      [Q1,mesh,fevals] = quade(func, a, ab2, tol/2, fa, fa3b1, fab2, saab, ...
                                 level-1, fevals, mesh);
      [Q2,mesh,fevals] = quade(func, ab2, b, tol/2, fab2, fa1b3, fb, sabb, ...
                                 level-1, fevals, mesh);
      Q = Q1 + Q2;
    end
  end
